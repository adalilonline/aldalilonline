...
// 1) روابط RAW (لجلب الملفات للقراءة)
// 2) روابط API (للتعديل عبر PUT + جلب SHA)
const RAW_URLS = {
  // (أ) المستخدمين
  users: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/notused/userData.json',

  // (ب) الصف الأول (grade1)
  videos1: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade1/videos.json',
  files1: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade1/files.json',
  homework1: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade1/homework.json',
  exams1: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade1/exams.json',

  // (ج) الصف الثاني (grade2)
  videos2: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade2/videos.json',
  files2: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade2/files.json',
  homework2: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade2/homework.json',
  exams2: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade2/exams.json',

  // (د) الصف الثالث (grade3)
  videos3: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade3/videos.json',
  files3: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade3/files.json',
  homework3: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade3/homework.json',
  exams3: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade3/exams.json',

  // (هـ) الإعلانات (advertisment)
  advertisment: 'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/advertisment/advertisment.json'
};

const API_URLS = {
  // (أ) المستخدمين
  users: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/notused/userData.json',

  // (ب) الصف الأول
  videos1: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade1/videos.json',
  files1: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade1/files.json',
  homework1: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade1/homework.json',
  exams1: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade1/exams.json',

  // (ج) الصف الثاني
  videos2: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade2/videos.json',
  files2: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade2/files.json',
  homework2: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade2/homework.json',
  exams2: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade2/exams.json',

  // (د) الصف الثالث
  videos3: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade3/videos.json',
  files3: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade3/files.json',
  homework3: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade3/homework.json',
  exams3: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/grade3/exams.json',

  // (هـ) الإعلانات
  advertisment: 'https://api.github.com/repos/adalilonline/dasht/contents/dasht/advertisment/advertisment.json'
};

// التعديل الأهم هنا: نجلب التوكن من ملف .env
...
function AdminDashboard({ currentUser }) {
  ...
  // مفاتيح للفصل بين الأقسام الرئيسية (الـ Panels)
  ...
  function handleEditField(type, index, field, value) {
    ...
    switch (type) {
      ...
      // الإعلانات (advertisment) => { thumbnail }
      case 'advertisment':
  ...
  function handleAddItem(type) {
    ...
    // exams => { link, thumbnail }
    if (type.includes('exams')) {
      newItem = { link: '', thumbnail: '' };
    } else {
      // (videos / files / homework) => { id, thumbnail }
  ...
  async function saveToGitHub(type) {
    ...
    switch (type) {
      ...
      case 'advertisment':
        dataArr = advertismentData;
        sha = advertismentSha;
        setSavingFn = setSavingAd;
        break;
  ...
  return (
    <Container style={{ direction: 'rtl', textAlign: 'right', color: '#fff' }}>
      ...
      {/* (2) لوحة التحكم - الإعلانات (advertisment) */}
      <div style={{ marginBottom: '20px' }}>
        <div
    ...
    <div style={{ marginBottom: '20px' }}>
      ...
      {dataArray.length === 0 ? (
        ...
        <Table bordered hover variant="dark">
          <thead>
            {type === 'users' ? (
              // كود مختلف للمستخدمين، لكننا نعالجه خارج هذا المكوّن
              <tr>
                <th>اسم المستخدم</th>
                <th>كلمة المرور</th>
              </tr>
            ) : type === 'advertisment' ? (
              // الإعلانات تحتوي فقط على thumbnail
              <tr>
                <th>#</th>
                <th>thumbnail</th>
                <th>حذف</th>
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <Form.Control
                        ...
                        onChange={(e) => handleEditField(type, index, 'thumbnail', e.target.value)}
                      />
                    </td>
                    <td>
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <Form.Control
                        type="text"
                        value={item.id || ''}
                        onChange={(e) => handleEditField(type, index, 'id', e.target.value)}
                      />
                    </td>
                    <td>
                      <Form.Control

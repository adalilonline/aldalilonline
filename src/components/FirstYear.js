...
function FirstYear() {
  ...
  return (
    <Container
      style={{ direction: 'rtl', textAlign: 'right', color: '#fff' }}
      className="my-4"
    >
        ...
        <Modal.Body>
          {selectedExam && (
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              ...
              />
              {/* Overlay: قد يكون عديم الفائدة مع Forms، لكن نضعه للاتساق */}
              <div
                style={{
                  position: 'absolute',
                  top: 0,

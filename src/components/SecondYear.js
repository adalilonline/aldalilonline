...
function SecondYear() {
  // ------------------ حالات البيانات المجلوة (videos, files, homework, exams) ------------------
  ...
  // ------------------ (Fetch) جلب البيانات من GitHub للصف الثاني ------------------
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        const res = await fetch(
          'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade2/videos.json'
        );
    ...
    const fetchFiles = async () => {
      try {
        const res = await fetch(
          'https://raw.githubusercontent.com/adalilonline/dasht/main/dasht/grade2/files.json'
        );
    ...
    // استدعاء الدوال الأربع بالتوازي
    fetchVideos();
    fetchFiles();
    fetchHomework();
    fetchExams();
    ...
    <Container style={{ direction: 'rtl', textAlign: 'right', color: '#fff' }} className="my-4">
      ...
      <Modal show={showVideosModal} onHide={handleCloseVideosModal} centered size="xl">
        <Modal.Header closeButton>
          <Modal.Title>الفيديوهات (سنة ثانية)</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row
      ...
      <Modal show={showFilesModal} onHide={handleCloseFilesModal} centered size="xl">
        <Modal.Header closeButton>
          <Modal.Title>الملفات (سنة ثانية)</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row
            className="d-flex flex-row-reverse flex-wrap justify-content-center"
      ...
      <Modal show={showHomeworkModal} onHide={handleCloseHomeworkModal} centered size="xl">
        <Modal.Header closeButton>
          <Modal.Title>الواجبات (سنة ثانية)</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row
            className="d-flex flex-row-reverse flex-wrap justify-content-center"
      ...
      <Modal show={showExamsModal} onHide={handleCloseExamsModal} centered size="xl">
        <Modal.Header closeButton>
          <Modal.Title>الامتحانات (سنة ثانية)</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row
            className="d-flex flex-row-reverse flex-wrap justify-content-center"
